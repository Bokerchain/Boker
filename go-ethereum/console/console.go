...
import (
	...
	"github.com/boker/go-ethereum/internal/jsre"
	"github.com/boker/go-ethereum/internal/web3ext"
...
//从远程RPC提供程序检索可用的API并进行初始化控制台基于公开模块的JavaScript命名空间
func (c *Console) init(preload []string) error {

	//初始化JavaScript < - > Go RPC桥接
