...
contract BokerVerifyVote is AccessControl, Log {
    ...
    */
    function getVoteRound() onlyImplemented view external returns(uint256 round) {
        return impl.getVoteRound();
    }
    ...
    */
    function getCandidates() onlyImplemented view external returns(address[] memory addresses, uint256[] memory tickets) {
