...
type Api interface {
	...
	SetContract(address common.Address, contractType protocol.ContractType) error                //设置合约级别
	SubmitBokerTransaction(ctx context.Context, txType protocol.TxType, to common.Address) error //产生一个设置验证者交易
