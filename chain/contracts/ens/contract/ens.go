...
//DeployFIFSRegistrar部署一个新的以太坊合约，将FIFSRegistrar的实例绑定到它。
...
//DeployPublicResolver部署一个新的以太坊合约，将PublicResolver的实例绑定到它。
...
//DeployResolver部署一个新的以太坊合约，将Resolver的实例绑定到它。
